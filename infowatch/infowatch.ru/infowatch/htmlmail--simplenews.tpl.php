...
<div class="htmlmail-simplenews-link" style="text-align:center; padding:10px; margin-bottom:10px;">
  <a href="<?php echo url('node/' . $params['simplenews_source']->getNode()->nid, array('absolute' => TRUE)); ?>" style="font-size:11px; color:#000;">
    <?php print t('Click here to view this message on the web')?>
  </a>
</div>
<div class="htmlmail-simplenews-body htmlmail-body" >
<?php 
$q=$params['simplenews_source']->getNode()->body;
echo $q['ru'][0]['value']; 
