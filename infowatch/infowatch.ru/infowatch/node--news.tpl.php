...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($display_submitted): ?>
    <span class="submitted"><?php print $submitted ?>
	 <?php if (isset($content['body']['#object']->field_expert_flag)){
		$field_expert=$content['body']['#object']->field_expert_flag;
		if (isset($field_expert['und']['0']['value'])){
			if ($field_expert['und']['0']['value']=='1'){
				?><div class="field-expert-flag"><img width="23" height="21" title="Комментарий эксперта InfoWatch" src="/sites/all/themes/infowatch/images/new_style/comment_icon.png"></div>
				<?php				
			}
		}
	}
