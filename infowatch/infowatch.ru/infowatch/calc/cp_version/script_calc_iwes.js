(function ($) {
  Drupal.behaviors.Calculation = {
    attach: function (context, settings) {
		var price_olds = {"sale1":1, "sale2":2, "sale3":3};
		var price_base = {"price1":999, "price2":1898, "price3":2697, "sale1":1, "sale2":0.95, "sale3":0.9};
		var price_total = {"price1":1887, "price2":3330, "price3":4995, "sale1":1, "sale2":0.95, "sale3":0.9};
		var sale_moduls = {"sale":0.9, "sale1":1, "sale2":0.85, "sale3":0.83};
		var price_for = {"au_modul":444, "acc_modul":444, "pm_modul":444, "fe_modul":888, "de_modul":444, "apc_modul":444};
				...
				if(modul==0) {	
	    			...
	    			if(mdul_val!=0){
		    			...
		    			$("#moduls_bl li.checked").each(function() {
		    				...
		    				Summa = (test3*test2);
		    				$("#itogo_body").append("<tr><td>"+ poz_last + "</td><td class='title'>"+ test2 + "</td><td class='title'>"+ sale2 + "</td><td class='title'>"+ Math.round(test3) + " руб.</td><td class='title'>"+ Math.round(Summa) + " руб. </td></tr>");
	    			...
	    			if(mdul_val==0){
		    			...
		    			$("#moduls_bl li.checked").each(function() {
		    				...
		    				html_blocks = html_blocks + ("<tr><td>"+ poz_last + "</td><td class='title'>"+ test2 + "</td><td class='title'>"+ sale2 + "</td><td class='title'>"+ Math.round(test3) + " руб.</td><td class='title'>"+ Math.round(Summa) + " руб. </td></tr>");		
		    				Summa_ob = Summa_ob + (Summa*sale_gr);	
		    			});
		    			if (chertov_flag==1) {
			    			return false;
