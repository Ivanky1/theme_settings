    ...
    ru: {
        ...
        options: {
            country: [
                ...
                {"Burundi": "Бурунди"},
                {"Bhutan": "Бутан"},
                {"Republic of Vanuatu": "Вануату"},
                {"Vatican City": "Ватикан"},
                {"United Kingdom": "Великобритания"},
                {"Hungary": "Венгрия"},
                {"Venezuela": "Венесуэла Боливарианская Республика"},
                {"British Virgin Islands": "Виргинские острова, Британские"},
                {"Virgin Islands of the United States": "Виргинские острова, США"},
                {"Viet Nam": "Вьетнам"},
                {"Gabon": "Габон"},
                {"Haiti": "Гаити"},
                {"Guyana": "Гайана"},
