...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="content clearfix"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['links']);
	 global $language;
     if($language->language == 'apac' && arg(0) == 'taxonomy' && arg(1) == 'term' && is_numeric(arg(2))) {
         hide(render($content));
     } else {
 ...
 <div class="recomendation-bottom"></div>
  ...
  <div class="clearfix">
    <?php if (!empty($content['links']) && !($language->language == 'apac' && arg(0) == 'taxonomy' && arg(1) == 'term' && is_numeric(arg(2))) ): ?>
