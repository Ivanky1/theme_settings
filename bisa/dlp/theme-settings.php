...
/**
 * @file
 * Theme setting callbacks for the dlp theme.
 */
 ...
 *   The form state.
 */
function dlp_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['dlp_width'] = array(
    '#type' => 'radios',
    ...
    '#default_value' => theme_get_setting('dlp_width'),
