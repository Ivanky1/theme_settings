...
(function($){
    SlideDeck = function(el,opts){
        ...
        this.browser = {
            ...
            firefox2: UA.match(/firefox\/2\.0/) ? true : false,
            ...
            msie9: UA.match(/msie 10/) ? true : false,
        ...
        var buildDeck = function(){
            ...
            for(var i=0; i<self.slides.length; i++){
                ...
                if (self.options.hideSpines !== true) {
                    ...
                    var spinePadString = spinePad.top + "px " + spinePad.right + "px " + spinePad.bottom + "px " + (spinePad.left+45) + "px";
                    var spineStyles = {
                        position: 'absolute',
                        zIndex: 3,
                        display: 'block',
                        left: offset,
                        width: (height - (spinePad.left+45) - spinePad.right) + "px",
